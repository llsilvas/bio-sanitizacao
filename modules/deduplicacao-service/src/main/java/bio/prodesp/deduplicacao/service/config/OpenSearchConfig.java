...
/**
 * Configuração do cliente OpenSearch para deduplicacao-service
 *
 * <p>Permite consultar e atualizar índices do OpenSearch com dados de coletas biométricas.
 * Usado principalmente para consultar status de coletas e histórico de processamento.
 */
@Slf4j
@Configuration
